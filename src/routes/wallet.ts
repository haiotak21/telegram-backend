...
const PricingSchema = z.object({
  ...
  cardRequestWalletFeeTier1Usd: z.number().min(0).optional(),
  cardRequestWalletFeeTier2Usd: z.number().min(0).optional(),
  cardRequestWalletFeeTier3Usd: z.number().min(0).optional(),
  topupCommissionPercent: z.number().min(0).optional(),
  transferFeePercent: z.number().min(0).optional(),
  billPaymentFeePercent: z.number().min(0).optional(),
