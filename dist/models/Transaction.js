...
TransactionSchema.index({ transactionType: 1, transactionNumber: 1, userId: 1 }, { unique: true, sparse: true });
// Also enforce uniqueness when the reference number is used
TransactionSchema.index({ transactionType: 1, referenceNumber: 1, userId: 1 }, { unique: true, sparse: true });
